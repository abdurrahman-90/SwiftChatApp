   ...
   private var selfSender : Sender? {
    ...
    init(with email : String , id : String?){
        ...
        if let conversationID = conversationID {
            self.listenForMessages(id: conversationID,  shouldBottomScroll : true)
        }
    ...
    private func listenForMessages(id: String , shouldBottomScroll : Bool) {
            ...
            case .success(let messages):
             ...
             DispatchQueue.main.async {
                ...
                if shouldBottomScroll {
                    ...
                    self?.messagesCollectionView.scrollToItem(at: indexPath, at: .top, animated: true)
                }
        ...
        if isNewconversation {
            ...
            DatabaseManager.shared.createNewConversation(with: otherUserEmail, name: self.title ?? "User", firstMessage: mmessage, completion: { [weak self]success in
                if success {
                    ...
                    self?.listenForMessages(id: newConversationId, shouldBottomScroll: true)
...
extension ChatViewController : MessagesDataSource , MessagesLayoutDelegate , MessagesDisplayDelegate {
    func currentSender() -> SenderType {
        ...
        fatalError("bu işlem tamamlanmadı")
    }
